...
public class otherPrimeFact {
	...
	//it takes in longs from a scanner
	public static void main(String[] args) 
	{
		...
		long prod = 1;
		ArrayList<Integer> factors = listPrimeFact(factee);
	...
	static boolean isPrime (long testNumb)
	{
		 if (testNumb <= 1) {
	         return false;
	     }
	...
	public static ArrayList<Integer> listPrimeFact(long numb)
{
	ArrayList<Integer> primeFacts = new ArrayList<Integer>();
			...
			for (int i = 2; i <= Math.sqrt(numb) && numb > 1; i+= 2)
			{
